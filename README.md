...
한국어·원어의 단어·구에 마우스를 올리면 대응하는 부분을 함께 강조합니다. 터치와 키보드 좌우 화살표도 지원합니다. [대응 데이터](data/phrase-alignments.json)는 167구절의 1,403개 구간과 원문·번역 수정본을 연결합니다. 현재 번역에 근거한 AI 대응이며 사람 검수는 실시하지 않았습니다.
